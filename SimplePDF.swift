...
open class SimplePDF {
    ...
    fileprivate func drawTextInCell(_ rect: CGRect, text: NSString, font: UIFont) {
        ...
        let attributes: [NSAttributedStringKey : Any] = [
            NSAttributedStringKey(rawValue: NSAttributedStringKey.foregroundColor.rawValue): fieldColor,
            NSAttributedStringKey(rawValue: NSAttributedStringKey.paragraphStyle.rawValue): paraStyle,
            NSAttributedStringKey(rawValue: NSAttributedStringKey.obliqueness.rawValue): skew as AnyObject,
            NSAttributedStringKey(rawValue: NSAttributedStringKey.font.rawValue): font
        ]
